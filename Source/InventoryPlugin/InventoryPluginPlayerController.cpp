...
#include "InventoryPluginPlayerController.h"
...
void AInventoryPluginPlayerController::BeginPlay()
{
	...
	if (SVirtualJoystick::ShouldDisplayTouchInterface() && IsLocalPlayerController())
	{
		...
		if (MobileControlsWidget)
		{
			...
			UE_LOG(LogInventoryPlugin, Error, TEXT("Could not spawn mobile controls widget."));
...
void AInventoryPluginPlayerController::SetupInputComponent()
{
